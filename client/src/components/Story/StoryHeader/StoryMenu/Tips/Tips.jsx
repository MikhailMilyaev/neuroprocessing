...
const DEFAULT_ITEMS = [
  "Где и когда всё произошло?",
  "Кто был рядом в тот момент?",
  "Что случилось в самом начале?",
  "Какая деталь запомнилась сильнее всего?",
  "Как развивалось событие по шагам?",
  "Что конкретно делали вы?",
  "Что делали или говорили другие?",
  "Какие слова особенно задели?",
  "Какая мысль возникла первой?",
  "Какие мысли повторялись чаще всего?",
  "Что вы чувствовали в теле?",
  "Какие эмоции возникали сильнее всего?",
  "Что хотелось сделать, но вы не сделали?",
  "От чего хотелось уйти или скрыться?",
  "Что было для вас самым важным тогда?",
  "Какие ожидания вы имели до этого?",
  "Что вас особенно задело или вызвало отклик?",
  "Какие прошлые ситуации вспоминаются?",
  "Какие убеждения звучали внутри?",
  "Чего вы больше всего боялись?",
  "Что реально произошло в итоге?",
  "Что в этой истории болит сильнее всего?",
  "Что вы могли контролировать, а что нет?",
  "Как бы это выглядело со стороны?",
  "Чего вам тогда не хватало?",
  "Что бы вы сделали иначе, если бы могли?",
  "Какая альтернатива была возможна?",
  "Что вы хотели бы получить от других?",
  "Какая ценность здесь затронута?",
  "Чему вас научила эта ситуация?",
  "Что попробуете сделать иначе в будущем?"
];
